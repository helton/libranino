...
PROJECT_OBJS = \
	uno/project/LinkedListTest.cpp.o \
...
TARGETS = \
	uno/LinkedListTest.hex \

all: $(TARGETS)

uno/LinkedListTest.hex: uno/LinkedListTest.elf
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-objcopy" -O ihex -R .eeprom  "uno/LinkedListTest.elf" "uno/LinkedListTest.hex"

uno/LinkedListTest.elf: $(PROJECT_OBJS) $(LIBRARIES_OBJS) uno/core.a
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-gcc" -w -Os -Wl,--gc-sections -mmcu=atmega328p  -o "uno/LinkedListTest.elf" $(PROJECT_OBJS) $(LIBRARIES_OBJS) "uno/core.a" "-Luno" -lm
...
size:
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-size" -A "uno/LinkedListTest.elf"
