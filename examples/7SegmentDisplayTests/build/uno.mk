...
PROJECT_OBJS = \
	uno/project/7SegmentDisplayTests.cpp.o \
...
TARGETS = \
	uno/7SegmentDisplayTests.hex \

all: $(TARGETS)

uno/7SegmentDisplayTests.hex: uno/7SegmentDisplayTests.elf
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-objcopy" -O ihex -R .eeprom  "uno/7SegmentDisplayTests.elf" "uno/7SegmentDisplayTests.hex"

uno/7SegmentDisplayTests.elf: $(PROJECT_OBJS) $(LIBRARIES_OBJS) uno/core.a
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-gcc" -w -Os -Wl,--gc-sections -mmcu=atmega328p  -o "uno/7SegmentDisplayTests.elf" $(PROJECT_OBJS) $(LIBRARIES_OBJS) "uno/core.a" "-Luno" -lm
...
size:
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-size" -A "uno/7SegmentDisplayTests.elf"

uno/project/7SegmentDisplayTests.cpp.o: ../7SegmentDisplayTests.cpp
	@$(call mymkdir,$(dir $@))
