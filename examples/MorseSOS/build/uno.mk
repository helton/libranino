...
uno/MorseSOS.hex: uno/MorseSOS.elf
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-objcopy" -O ihex -R .eeprom  "uno/MorseSOS.elf" "uno/MorseSOS.hex"

uno/MorseSOS.elf: $(PROJECT_OBJS) $(LIBRARIES_OBJS) uno/core.a
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-gcc" -w -Os -Wl,--gc-sections -mmcu=atmega328p  -o "uno/MorseSOS.elf" $(PROJECT_OBJS) $(LIBRARIES_OBJS) "uno/core.a" "-Luno" -lm
...
size:
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-size" -A "uno/MorseSOS.elf"

uno/project/MorseSOS.cpp.o: ../MorseSOS.cpp
	@$(call mymkdir,$(dir $@))
