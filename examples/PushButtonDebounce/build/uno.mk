...
PROJECT_OBJS = \
	uno/project/PushButtonDebounce.cpp.o \
...
TARGETS = \
	uno/PushButtonDebounce.hex \

all: $(TARGETS)

uno/PushButtonDebounce.hex: uno/PushButtonDebounce.elf
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-objcopy" -O ihex -R .eeprom  "uno/PushButtonDebounce.elf" "uno/PushButtonDebounce.hex"

uno/PushButtonDebounce.elf: $(PROJECT_OBJS) $(LIBRARIES_OBJS) uno/core.a
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-gcc" -w -Os -Wl,--gc-sections -mmcu=atmega328p  -o "uno/PushButtonDebounce.elf" $(PROJECT_OBJS) $(LIBRARIES_OBJS) "uno/core.a" "-Luno" -lm
...
size:
	"/home/helton/.arduinocdt/tools/arduino/avr-gcc/4.8.1-arduino5/bin/avr-size" -A "uno/PushButtonDebounce.elf"

uno/project/PushButtonDebounce.cpp.o: ../PushButtonDebounce.cpp
	@$(call mymkdir,$(dir $@))
